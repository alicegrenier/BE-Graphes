...
public class TestPCC {
    ...
    // calcul du coût du chemin en fonction du scénario

    public double test_scenario(String map, int nature_cout,
        ...
        try (final GraphReader reader = new BinaryGraphReader(new DataInputStream(
            ...
            // on teste qu'on a bien une origine et une destination différente
                ...
                /* en fonction de la valeur de nature_cout, choisir FastestPath ou ShortestPath lui donner l'origine 
                et la destination d'où on part lancer l'algo pour obtenir le chemin on récupère le résultat */ 
                ...
                if (algo != 'a' && algo != 'b' && algo != 'd') { // si on a rentré la mauvaise lettre
                    System.out.println(
    ...
    // test de différents scénarios avec le résultat attendu (utiliser des asserts pour pallier le fait qu'on ne peut pas utiliser Bellman-Ford
    ...
    public void trajet_voiture_ouvert_que_pietons_dijkstra() {
     ...
     /* @Test  // rate car l'origine et la destination ne sont pas les mêmes dans le test et le résultat attendu 
    ...
    public void test_trajet_long_dijkstra() {
        // trajet sur une grande distance toute route autorisée 
        String map_choisie = "bretagne.mapgr";
    ...
    @Test // test sur un chemin pas autorisé aux voitures
    public void trajet_voiture_ouvert_que_pietons_astar() {
      ...
      public void test_origine_et_dest_différentes_astar() { 
        String map_choisie = "insa.mapgr" ; 
        assertEquals(test_scenario(map_choisie, 1, 2, 1095, 462, 'a'), 
        test_scenario(map_choisie, 1, 2, 1095, 760, 'd'), 0); } 
      //==> fonctionne mais du coup commenté pour éviter de faire planter le programme
     */
